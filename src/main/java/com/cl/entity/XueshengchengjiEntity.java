...
public class XueshengchengjiEntity<T> implements Serializable {
	 ...
	 * 设置：成绩类型
	 */
	public void setChengjileixing(String chengjileixing) {
		this.chengjileixing = chengjileixing;
	}
	/**
	 * 获取：成绩类型
	 */
	public String getChengjileixing() {
		return chengjileixing;
	}
	/**
	 * 设置：学期
	 */
